...
public class RMHCNaiveInstanceSelectionGeneralModel extends AbstractInstanceSelectorModel {
     ...
     * @param loss
     */
    public RMHCNaiveInstanceSelectionGeneralModel(DistanceMeasure measure, int populationSize, int iterations, RandomGenerator randomGenerator, ILossFunction loss) {
    ...
    public DataIndex selectInstances(SelectedExampleSet exampleSet) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            for (Example testExample : exampleSet) {
                ...
                errorRate += loss.getLoss(realLabel,predictedLabel,testExample);
            }
