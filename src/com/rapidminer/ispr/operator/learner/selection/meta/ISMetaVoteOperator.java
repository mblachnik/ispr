 ...
 * @author Marcin
 */
public class ISMetaVoteOperator extends AbstractPRulesOperatorChain {
    ...
    public ISMetaVoteOperator(OperatorDescription description) {
    ...
    public ExampleSet processExamples(ExampleSet trainingSet) throws OperatorException {
        ...
        if (modelOutputPort.isConnected()) {
            ...
            if (output.getAttributes().getLabel().isNominal()) {
                ...
                MyKNNClassificationModel<IntDoubleContainer> model = new MyKNNClassificationModel<IntDoubleContainer>(output, samples, 1, VotingType.MAJORITY, false);
                modelOutputPort.deliver(model);
            }
        }
