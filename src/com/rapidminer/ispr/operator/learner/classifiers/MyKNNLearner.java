 ...
 *
 */
public class MyKNNLearner extends AbstractLearner {
     ...
     * @param description
     */
    public MyKNNLearner(OperatorDescription description) {
        super(description);
    ...
    public Model learn(ExampleSet exampleSet) throws OperatorException {
        ...
        if (exampleSet.getAttributes().getLabel().isNominal()) {
            ...
            return new MyKNNClassificationModel<Number>(exampleSet, samples, getParameterAsInt(PARAMETER_K), weightingType, false);
        }
